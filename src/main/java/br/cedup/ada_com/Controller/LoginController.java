...
public class LoginController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        entrarButton.setOnMouseEntered(e -> entrarButton.setStyle("-fx-background-color: white; -fx-text-fill: black; -fx-border-color: white;"));
        entrarButton.setOnMouseExited(e -> entrarButton.setStyle("-fx-background-color: #0c0c0c; -fx-text-fill: white; -fx-border-color: white;"));
    }
}
